...
var totaler = document.createElement("tr")
...
td4.imageHTML = "$"+orderSummary.total_bill
totaler.appendChild(td1)
totaler.appendChild(td2)
totaler.appendChild(td3)
totaler.appendChild(td4)
tableBodyTag.appendChild(totaler)
  ...
  handlePayment: function(){
    document.getElementById("model-deal").style.display="none"
    var tableNumber
    tableNumber <= 9 ? (tNumber = `T0${tableNumber}`) : `T${tableNumber}`;
